...
const MeetingTypeList = () => {
    ...
    const [meetingState, setMeetingState] = useState<
        'isScheduleMeeting' | 'isJoiningMeeting' |
    ...
    md:grid-cols-2 xl:grid-cols-4'>
            ...
            <HomeCard
                ...
                handleClick={() => setMeetingState
                    ('isScheduleMeeting')}
                className="bg-blue-1 w-auto h-auto" />
            ...
            <HomeCard
                ...
                className="bg-purple-1 w-auto h-auto" />
            ...
            <HomeCard
                ...
                handleClick={() => setMeetingState
                    ('isJoiningMeeting')}
                className="bg-yellow-1 w-full h-auto"
            />
            {!callDetails ? (
...
>
    <DialogTitle className="sr-only">Create Meeting</DialogTitle> {/* Added for accessibility */}
    ...
    <div className="flex w-full flex-col gap-2.5">
        ...
        />
                ...
                //      timeCaption="time"
                //      dateFormat="MMMM d, yyyy h:mm aa"
                //      className="w-full rounded bg-dark-3
